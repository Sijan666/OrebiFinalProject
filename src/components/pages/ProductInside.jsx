                    ...
                    <div className="pb-[30px] border-b border-[#F0F0F0]">
                        ...
                        <div className="flex gap-x-10 items-center">
                            ...
                            <div className="flex gap-x-4 py-1 px-5 border border-[#F0F0F0]">
                                <button aria-label="Decrement value" onClick={() => { if (count > 1) {dispatch(decrement())}}} className="text-[#767676] text-[20px]">-</button>
                                <span className="text-[#767676] text-[20px]">{count}</span>
                                <button aria-label="Increment value" onClick={() => dispatch(increment())} className="text-[#767676] text-[20px]">+</button>
                            </div>
                        </div>
                    </div>
